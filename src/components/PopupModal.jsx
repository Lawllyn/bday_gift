    ...
    <div className="popup-overlay" style={{ display: 'flex', zIndex: type === 'kupon' ? 110 : 100 }}>
      <div className="popup-content">
        ...
        {type === 'thanks' && (
          <React.Fragment>
            <img 
              src={`${import.meta.env.BASE_URL}foto/cakecat.jpg`} 
              alt="Photo" 
              className="popup-img-src" 
            />
        ...
        {type === 'sorry' && (
          <React.Fragment>
            <img 
              src={`${import.meta.env.BASE_URL}foto/finalboz.jpg`} 
              alt="photo" 
              className="popup-img-src" 
            />
            <p className="popup-letter-text">
        ...
        {type === 'kupon' && (
          <React.Fragment>
            <img 
              src={`${import.meta.env.BASE_URL}foto/antimarah.png`} 
              alt="Kupon Anti Marah" 
              className="popup-img-src" 
            />
